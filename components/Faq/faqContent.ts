...
const content: FaqQuestionsType = [
  ...
  },
  {
    ...
    answer:
      "Non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur. Vel illum qui dolorem eum fugiat quo voluptas nulla pariatur, quis nostrud exercitation ullamco laboris nisi ut aliquip.",
  },
  {
    question: "At vero eos et accusamus?",
    answer:
      "Et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores. Et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat. Et harum quidem rerum facilis est et expedita distinctio.",
  },
  {
    question: "Nam libero tempore soluta?",
    answer:
      "Nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus. Omnis voluptas assumenda est, omnis dolor repellendus temporibus autem quibusdam.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Fuga et harum quidem rerum facilis est et expedita distinctio nam libero tempore. Cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime.",
  },
  {
    question: "Placeat facere possimus?",
    answer:
      "Omnis voluptas assumenda est omnis dolor repellendus temporibus autem quibusdam et aut officiis. Debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae.",
  },
];
